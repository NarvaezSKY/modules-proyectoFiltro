export const rutas = [
  ...
  // Acceder a la información de una ruta específica por su id
  const rutaEjemplo = rutas.find(ruta => ruta.id === 1);
  // console.table(rutaEjemplo)
//   console.log("Nombre:", rutaEjemplo.nombre);
//   console.log("Kilómetros:", rutaEjemplo.minKilometros, "-", rutaEjemplo.maxKilometros);
//   console.log("Estado:", rutaEjemplo.estado);
//   console.log("Calificación:", rutaEjemplo.calificacion);
//   console.log("Tipo de Via:", rutaEjemplo.tipoVia);